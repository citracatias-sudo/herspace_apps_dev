...
class HerSpaceApp extends StatelessWidget {
  const HerSpaceApp({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // the splash screen remains the initial widget; additional routes make navigation predictable
      home: SplashScreen(),
      routes: {
